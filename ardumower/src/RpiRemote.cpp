...
void RpiRemote::run() {
  ...
  /*if (millis() >= nextTimeRaspberryPISendErr) {
    nextTimeRaspberryPISendErr = millis() + 500;  //better to put 200
    RaspberryPISendErr();
    }*/
...
// Send errors to pi
void RpiRemote::RaspberryPISendErr () {
  String lineToSend;
  lineToSend = "RMERR,";
  lineToSend = lineToSend + millis();
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_CHARGER];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_BATTERY];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_MOTOR_LEFT];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_MOTOR_RIGHT];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_MOTOR_MOW];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_MOW_SENSE];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_ODOMETRY_LEFT];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_ODOMETRY_RIGHT];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_PERIMETER_TIMEOUT];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_TRACKING];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_IMU_COMM];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_IMU_CALIB];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_IMU_TILT];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_RTC_COMM];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_RTC_DATA];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_GPS_COMM];
  lineToSend = lineToSend + ",";
  lineToSend = lineToSend + robot->errorCounterMax[ERR_GPS_DATA];
  lineToSend = lineToSend + ",";
